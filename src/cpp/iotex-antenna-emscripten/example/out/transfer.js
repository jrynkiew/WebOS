...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'out/transfer.data';
      var REMOTE_PACKAGE_BASE = 'transfer.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_out/transfer.data');

      };
      Module['addRunDependency']('datafile_out/transfer.data');
   ...
   loadPackage({"files": [{"filename": "/cacert.pem", "start": 0, "end": 221363, "audio": 0}], "remote_package_size": 221363, "package_uuid": "ec9df249-330d-4d84-8548-8d20304b3b95"});
...
var wasmBinaryFile = 'transfer.wasm';
