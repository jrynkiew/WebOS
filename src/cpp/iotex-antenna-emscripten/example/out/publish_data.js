...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'out/publish_data.data';
      var REMOTE_PACKAGE_BASE = 'publish_data.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_out/publish_data.data');

      };
      Module['addRunDependency']('datafile_out/publish_data.data');
   ...
   loadPackage({"files": [{"filename": "/cacert.pem", "start": 0, "end": 221363, "audio": 0}], "remote_package_size": 221363, "package_uuid": "9c1a7b01-1d3f-4c89-b57d-739b9dd3d848"});
...
var wasmBinaryFile = 'publish_data.wasm';
