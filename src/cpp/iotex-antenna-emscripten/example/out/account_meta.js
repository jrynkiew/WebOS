...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
   var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'out/account_meta.data';
      var REMOTE_PACKAGE_BASE = 'account_meta.data';
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_out/account_meta.data');

      };
      Module['addRunDependency']('datafile_out/account_meta.data');
   ...
   loadPackage({"files": [{"filename": "/cacert.pem", "start": 0, "end": 221363, "audio": 0}], "remote_package_size": 221363, "package_uuid": "a2e678f5-2955-44d8-8caf-0c8a75529fd5"});
...
var wasmBinaryFile = 'account_meta.wasm';
