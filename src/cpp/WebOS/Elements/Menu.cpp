...
void WebOS_Menu::showMainMenu()
{
    ...
    */
    if (MenuToggle)
    {
        ...
        ImGui::SetNextWindowSize(InitializeMenu.getMenuSize(), ImGuiCond_FirstUseEver);
        ...
        ImGui::Begin("MainMenu", NULL, ImGuiWindowFlags_NoBackground | ImGuiWindowFlags_NoTitleBar | ImGuiWindowFlags_NoScrollbar);
