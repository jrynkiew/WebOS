...
void ImGui::ShowDemoWindow(bool* p_open)
{
   ...
   // if (show_app_console)             ShowExampleAppConsole(&show_app_console);
    ...
    ImGui::SetNextWindowPos(ImVec2(198, 76), ImGuiCond_FirstUseEver);
    ImGui::SetNextWindowSize(ImVec2(773, 575), ImGuiCond_FirstUseEver);

    // Main body of the Demo window starts here.
    if (!ImGui::Begin("WebOS | IoTeX integration", p_open, window_flags))
    {
...
bool ImGui::ShowStyleSelector(const char* label)
{
    ...
    if (ImGui::Combo(label, &style_idx, "Classic\0Dark\0Light\0JRPC\0"))
    {
        switch (style_idx)
        {
        ...
        case 3: ImGui::StyleColorsIoTeX(); break;
        }
        return true;
    }
    return false;
...
/*struct ExampleAppConsole
{
    ...
    void    Draw(const char* title, bool* p_open)
    {
        ...
        if (ImGui::SmallButton("WTF!?"))  { AddLog("%d some text", Items.Size); AddLog("some more text"); AddLog("display very important message here!"); } ImGui::SameLine();
