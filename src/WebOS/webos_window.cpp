...
static void ShowExampleAppDockSpace(WebOS* web_os);
...
void ShowExampleAppDockSpace( WebOS* web_os)
{
        web_os->dockspaceID = ImGui::DockSpaceOverViewport(ImGui::GetMainViewport());
