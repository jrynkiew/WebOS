...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']('/', 'images', true, true);
   ...
   loadPackage({"files": [{"filename": "/images/wallpaper.png", "start": 0, "end": 523028, "audio": 0}, {"filename": "/images/icon.png", "start": 523028, "end": 536652, "audio": 0}], "remote_package_size": 536652, "package_uuid": "9de43182-3ea5-49f8-bbec-46602d8d18c9"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 164992,
    DYNAMIC_BASE = 5407872,
    DYNAMICTOP_PTR = 164832;
...
var ASM_CONSTS = {
 ...
 111104: function($0) {if (Module['canvas']) { Module['canvas'].style['cursor'] = UTF8ToString($0); } return 0;},  
 111197: function() {if (Module['canvas']) { Module['canvas'].style['cursor'] = 'none'; }},  
 112422: function() {return screen.width;},  
 112449: function() {return screen.height;},  
 112477: function() {return window.innerWidth;},  
 112509: function() {return window.innerHeight;},  
 112587: function($0) {if (typeof Module['setWindowTitle'] !== 'undefined') { Module['setWindowTitle'](UTF8ToString($0)); } return 0;},  
 112741: function() {if (typeof(AudioContext) !== 'undefined') { return 1; } else if (typeof(webkitAudioContext) !== 'undefined') { return 1; } return 0;},  
 112907: function() {if ((typeof(navigator.mediaDevices) !== 'undefined') && (typeof(navigator.mediaDevices.getUserMedia) !== 'undefined')) { return 1; } else if (typeof(navigator.webkitGetUserMedia) !== 'undefined') { return 1; } return 0;},  
 113133: function($0) {if(typeof(Module['SDL2']) === 'undefined') { Module['SDL2'] = {}; } var SDL2 = Module['SDL2']; if (!$0) { SDL2.audio = {}; } else { SDL2.capture = {}; } if (!SDL2.audioContext) { if (typeof(AudioContext) !== 'undefined') { SDL2.audioContext = new AudioContext(); } else if (typeof(webkitAudioContext) !== 'undefined') { SDL2.audioContext = new webkitAudioContext(); } } return SDL2.audioContext === undefined ? -1 : 0;},  
 113616: function() {var SDL2 = Module['SDL2']; return SDL2.audioContext.sampleRate;},  
